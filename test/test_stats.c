...
{
    rp->name = "st_vec_mean";
    st_d64 target = 1.89386753961467;
...
{
    rp->name = "st_vec_std";
    st_d64 target = 0.92479199007635;
...
test__st_vec_cov(result *rp)
{
    ...
    st_d64 cov = st_stats_cov(vec1, vec2, 1);
...
test__st_vec_corr(result *rp)
{
    ...
    st_vector *vec1 = test_d_vec_1();
    st_vector *vec2 = test_d_vec_2();
    st_d64 corr = st_stats_corr(vec1, vec2);
