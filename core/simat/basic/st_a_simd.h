...
#define st_m_and_d(da, db) _mm_and_pd(da, db)
...
#define st_m_setall_i64(i) _mm_set1_epi64x(i)
#define st_m_set_d64(st_d64) _mm_set1_pd(st_d64)

/* Cast */
#define st_m_cast_i2d(st_mi) _mm_castsi128_pd(st_mi)
...
#define st_m_setall_i64(i) _mm256_set1_epi64x(i)
#define st_m_set_d64(st_d64) _mm256_set1_pd(st_d64)

/* Cast */
#define st_m_cast_i2d(st_mi) _mm256_castsi256_pd(st_mi)
