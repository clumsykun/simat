...
void
__st_check_invalid_error(const void *target)
{
...
double
__st_raise_out_range_error(void)
{
    __st_is_error = true;
 ...
 */
void
__st_check__(const char *file, const size_t line)
{
